...
import Botao from './arquivos/Botao'
import Display from './arquivos/Display' 
			...
			<>
				...
				<View style={styles.container}>	
					...
					<View style={styles.master}>
						...
						<Botao label='+' operation onClick={() => this.setOperation("+")}> </Botao>
						...
						<Botao label='0' double onClick = {() => this.addDigit(1)}> </Botao> 
